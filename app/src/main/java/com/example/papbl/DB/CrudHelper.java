...
public class CrudHelper {
    ...
    public ArrayList<HashMap<String, String>> getMahasiswa(@Nullable String _id) {
        ...
        String[] projection = {
                ...
                //biar tidak ambigu nama kolom "nama" di dosen dan mahasiswa
        ...
        String selection = DatabaseContract.TbMahasiswa.TABLE_NAME + "." +
                DatabaseContract.TbMahasiswa.COLUMN_NAME_ID_DOSENPA + " = " +
                DatabaseContract.TbDosen.TABLE_NAME + "." +
                DatabaseContract.TbDosen._ID + " AND " +
        ...
        if (_id != null) {
            ...
            selection = DatabaseContract.TbMahasiswa.TABLE_NAME + "." +
                    DatabaseContract.TbMahasiswa.COLUMN_NAME_ID_DOSENPA + " = " +
                    DatabaseContract.TbDosen.TABLE_NAME + "." +
                    DatabaseContract.TbDosen._ID + " AND " +
                    DatabaseContract.TbMahasiswa.TABLE_NAME + "." +
                    DatabaseContract.TbMahasiswa.COLUMN_NAME_ID_JURUSAN + " = " +
                    DatabaseContract.TbJurusan.TABLE_NAME + "." +
                    DatabaseContract.TbJurusan._ID + " AND " +
                    DatabaseContract.TbMahasiswa.TABLE_NAME + "." +
                    BaseColumns._ID + " = ?";
        }
        ...
        Cursor cursor = db.query(
                DatabaseContract.TbMahasiswa.TABLE_NAME + " , " + DatabaseContract.TbDosen.TABLE_NAME + " , " + DatabaseContract.TbJurusan.TABLE_NAME, // The table to //query
                projection,
        ...
        while (cursor.moveToNext()) {
            ...
            String jurusan = cursor.getString(cursor.getColumnIndexOrThrow(DatabaseContract.TbJurusan.TABLE_NAME + "." + DatabaseContract.TbJurusan.COLUMN_NAME_JURUSAN));
    ...
    public ArrayList<HashMap<String, String>> getDosen(@Nullable String _id) {
        ...
        Cursor cursor = db.query(
                DatabaseContract.TbDosen.TABLE_NAME + "", // The table //to query
    ...
    public ArrayList<HashMap<String, String>> getJurusan(@Nullable String _id) {
        ...
        String[] projection = {
                BaseColumns._ID,
                DatabaseContract.TbJurusan.COLUMN_NAME_JURUSAN
        };
        String selection = null;
        String[] selectionArgs = null;
        if (_id != null) {
        ...
        while (cursor.moveToNext()) {
            String id = cursor.getString(cursor.getColumnIndexOrThrow(DatabaseContract.TbJurusan._ID));
            String namaJurusan = cursor.getString(cursor.getColumnIndexOrThrow(DatabaseContract.TbJurusan.COLUMN_NAME_JURUSAN));
            HashMap<String, String> jurusan = new HashMap<String, String>();
            jurusan.put("id", id);
            jurusan.put("namaJurusan", namaJurusan);
