...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_TbMAHASISWA = String.format(
    ...
    private static final String SQL_CREATE_TbJURUSAN = String.format(
    ...
    private static final String SQL_DELETE_TbDosen = "DROP TABLE IF EXISTS " +
            DatabaseContract.TbDosen.TABLE_NAME;
    private static final String SQL_DELETE_TbJurusan = "DROP TABLE IF EXISTS " +
            DatabaseContract.TbJurusan.TABLE_NAME;
}
